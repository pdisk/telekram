...
fun main() {
    parseAndSave(
        ...
        "../core/generated/commonMain/tk/hack5/telekram/core/tl",
        "tk.hack5.telekram.core.tl"
    )
    parseAndSave(
        "resources/schema-mtproto.json",
        "../core/generated/commonMain/tk/hack5/telekram/core/mtproto",
        "tk.hack5.telekram.core.mtproto"
    )
    writeErrors(
        "resources/errors.csv",
        "../core/generated/commonMain/tk/hack5/telekram/core/errors/Errors.kt",
        "tk.hack5.telekram.core.errors"
    )
}