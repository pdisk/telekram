...
import tk.hack5.telekram.core.tl.Account_PasswordObject
import tk.hack5.telekram.core.tl.InputCheckPasswordSRPObject
import tk.hack5.telekram.core.tl.InputCheckPasswordSRPType
import tk.hack5.telekram.core.tl.PasswordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPowObject
...
open class PasswordAuthenticator(protected val pbkdf2sha512: (ByteArray, ByteArray) -> ByteArray) {
    fun hashPasswordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow(
        ...
        val m1 = ((p.sha256() xor gByteArray.sha256()) + salt1.sha256() + salt2.sha256() + gAByteArray + gB + kA).sha256()
